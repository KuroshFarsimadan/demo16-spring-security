...
<body>
	...
	<div id="contentbox">
		...
		<h3>Functionality</h3>
		<p><i>Test the following users:</i><br/>
		Kurosh:Password1 (ROLE_USER) OR farsimadan:Password2 (ROLE_USER, ROLE_ADMIN)</p>
		<h3>Links</h3>
		<p>
		...
		<p>
			Extra pages:<br/>
			<a href="misc/admins">misc/admins</a><br/>
			<a href="misc/loggedin">misc/loggedin</a><br/>
			<a href="misc/all">misc/all</a><br/>
		</p>
	</div>
</body>
</html>